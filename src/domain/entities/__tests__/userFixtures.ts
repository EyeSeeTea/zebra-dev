import { User, UserRole, UserGroupPermissions } from "../User";
...
export function createUserWithGroups(userGroups: UserGroupPermissions[] = []): User {
    return new User({
        id: "YjJdEO6d38H",
        name: "John Traore",
        username: "user",
...
function createUser(userRoles: UserRole[], userGroups: UserGroupPermissions[] = []): User {
    return new User({
        id: "kQiwoyMYHBS",
        name: "John Traore",
        username: "user",
